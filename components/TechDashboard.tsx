...
export const TechDashboard: React.FC = () => {
    ...
    // Observa visibilidade para pausar interval quando fora da tela
    useEffect(() => {
    ...
    // Só roda o interval quando visível
    useEffect(() => {
        if (!isVisible) return;
    ...
    return (
        <div ref={ref} className="relative w-full h-[450px] bg-gray-900/40 rounded-3xl border border-white/10 p-6 overflow-hidden backdrop-blur-sm shadow-2xl aura-glow">
            {/* Background Accent */}
